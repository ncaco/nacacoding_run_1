package com.backend.common.member.memberRole.entity;
...
public class MemberRoleEntity {
	...
	@org.hibernate.annotations.Comment("역할 코드 (예: VIP, PREMIUM, BASIC, GUEST)")
	...
	public MemberRoleEntity(String roleCd, String roleNm, String roleDesc) {
		this.roleCd = roleCd;
		this.roleNm = roleNm;
