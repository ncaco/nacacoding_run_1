...
interface UserRoleFormProps {
  ...
  isLoading?: boolean;
  roleCdOptions?: Array<{ value: string; label: string }>;
}

export default function UserRoleForm({ onSubmit, onCancel, initialData, isLoading = false, roleCdOptions = [] }: UserRoleFormProps) {
          ...
          {!isEditMode && (
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500 dark:text-slate-300">
                P002 공통코드에서 역할 코드를 선택합니다. 생성 후 변경할 수 없습니다.
              </p>
            </div>
          )}
