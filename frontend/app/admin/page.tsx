          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-900 dark:shadow-gray-800/50">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400">전체 사이트</p>
            ...
            <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-900 dark:shadow-gray-800/50">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400">전체 로그</p>
                  <p className="mt-2 text-3xl font-bold text-gray-900 dark:text-white">0</p>
                </div>
    ...
    <AdminLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">시스템 개요 및 통계를 확인하세요.</p>
        </div>
